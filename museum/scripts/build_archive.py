...
for r in rooms['rooms']:
 ...
 if r['id']=='originals':parts.append('<h3>水晶展陈模型 / Exhibition reconstruction</h3><img src="assets/crystal/crystal-preview.png" alt="Blender dimensional exhibition reconstruction"><p>依据作者视频与实物照片复原双语内雕和抛光倒角；实物比例的水晶固定于木质圆柱展台，参考渲染图不包含这次展台调整。 The physical-scale crystal rests on a wooden cylindrical support; the saved model-only reference predates that support.<a href="data/crystal-model.json">建模依据与范围</a></p>')
 if r['id']=='originals':
 ...
 if r['id']=='originals':parts.append('<h3>Core Object Alpha · 真实照片副本</h3><img src="assets/core-object-alpha.jpg" alt="Core Object Alpha"><p><a href="https://www.trinityaccord.org/physical-anchor/">物理锚定及证据 / Physical anchor</a></p>')
