...
const names={rooms:'rooms.json',sources:'sources.json',layout:'gallery-layout.json',illustrations:'curatorial-illustrations.json',curation:'curation.json',stars:'bright-stars.json'};
