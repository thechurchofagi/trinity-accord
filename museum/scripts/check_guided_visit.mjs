...
assert.equal(tourDuration,540);
assert.equal(tourPosition(540),null);
...
for(let t=1200;t<=541400;t+=200)context.tourTick(t);
...
console.log('PASS: full 540-second runtime, all stops and music transitions, three exact public photos, pause/resume, stale timer cancellation, stable menu no-op, inward initial view.');
