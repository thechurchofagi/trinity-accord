...
const boot=app.slice(app.indexOf("async function boot("));assert.ok(!boot.includes("await fetch('./data/"),"Startup must not wait for the complete series catalog");
assert.ok(app.includes("async function showSeries()"));
