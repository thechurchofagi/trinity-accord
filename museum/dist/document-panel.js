...
export function createDocumentPanel(exhibit,language='en'){
 ...
 const complete=['canon-1','canon-2'].includes(exhibit.id)&&!!exhibit.originalText;
 ...
 g.fillText(guardian?'GUARDIAN PRINCIPLES  v1.1':(zh?'比特币正本  ':'BITCOIN ORIGINAL  ')+exhibit.id.slice(-1).padStart(2,'0')+'   /   '+exhibit.number,132,92);
 ...
 const footer=guardian?(zh?'后续守护材料 · 不是第四条正本':'LATER GUARDIANSHIP MATERIAL · NOT A FOURTH ORIGINAL'):complete?(zh?'铭文全文 · 保留原语言及历史占位文字':'COMPLETE INSCRIPTION · ORIGINAL LANGUAGE AND HISTORICAL PLACEHOLDERS RETAINED'):(zh?'2026 阅读导引 · 点击展板阅读完整正本':'2026 READING GUIDE · SELECT THE DISPLAY FOR THE COMPLETE ORIGINAL');
