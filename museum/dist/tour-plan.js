...
export const tourStops=[
  ...
  },
  {
    ...
    "seconds": 40,
    "zh": "如果没有人回应，等待还意味着什么？这份地址不预告一个答案必然到来。后来者可以阅读、质疑、回应，也可以保持沉默。文字已经留下。解释不必停在创作者这里。现在，您会如何阅读它？",
    "en": "What does waiting mean if no answer comes? This address does not promise a reply. A later reader may examine, question, respond, or remain silent. The records remain. Interpretation need not end with their creator. How would you read them?"
  }
];
