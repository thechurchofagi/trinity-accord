...
export function goldWindowMaterial(renderer){
 const interior=new THREE.Scene();interior.background=new THREE.Color('#9c9a92');
 ...
 const gold=mineralMaterial('#c8ac6e',{roughness:.34,metal:true});
 gold.name='Brushed gold window inlay';gold.metalness=1;gold.envMap=reflection.texture;gold.envMapIntensity=.85;
 return gold;
}
