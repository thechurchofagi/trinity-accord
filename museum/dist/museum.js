...
function enterTourStop(position){
 const s=position.stop;tourStep=position.index;tourMusicStarted=false;silenceGuide();closeFlaws();cancelMusic();$('music-bar').hidden=true;clearLyrics();
