...
const recordedGuide=createRecordedGuide($('narration'),{
 ...
 onState(state){if(state==='playing'||state==='muted'){tourLast=performance.now();if(motion)motion.time=tourLast;}if(roomData)updateTourStatus();}
});
