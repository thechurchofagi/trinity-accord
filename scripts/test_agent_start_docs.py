...
def main() -> None:
    ...
    for needle, label in [
        ...
        ("not currently supported as an ordinary public Builder route", "Guardian-signed Echo ordinary-public unsupported boundary"),
        ("historical or specialized `guardian_signed_echo`", "machine API legacy/specialized qualification"),
        ...
        ("guardian_presence_proof", "unsupported/specialized proof field name"),
