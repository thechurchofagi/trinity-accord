...
def main():
    ...
    parser.add_argument("--record-intent", default="intake_only", choices=["intake_only", "archive_preflight_only"])
    parser.add_argument("--requested-archive-kind", default="none", choices=["none", "archived_echo"])
