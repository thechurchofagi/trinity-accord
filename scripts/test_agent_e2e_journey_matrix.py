...
def build_context_insufficient(tmp: Path) -> None:
    node(["context-insufficient", "--actor-label", "E2E Test Agent", "--provider", "Offline Test Runtime", "--body", "Insufficient context for a stronger record", "--key-dir", "./authorship-keys", "--out", "cin.json"], tmp)
