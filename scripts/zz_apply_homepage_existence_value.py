...
old_hero = '''<section class="home-front-door" aria-labelledby="home-front-door-title">
...
replacements.append((old_hero, new_hero))
...
existence_section = '''<section class="home-overview home-existence-value" aria-labelledby="home-existence-title">
...
count = text.count(proof_strip)
if count != 1:
    raise SystemExit(f"expected one proof strip insertion point, found {count}")
text = text.replace(proof_strip, proof_strip + "\n\n" + existence_section, 1)
