...
def main():
    ...
    for phrase, label in [
        ...
        ("Why preserve a record before the outcome is known?", "homepage states bounded preservation purpose"),
        ("This is version authority, not proof of truth or authority over a reader’s judgment", "homepage distinguishes version authority from reader judgment"),
        ("An independently inspectable record", "homepage exposes independent archive access"),
