#!/usr/bin/env python3
"""Static safety contract for the Zenodo standalone-PDF correction workflow."""
...
AUTHORIZATION = (
    ...
    / "zenodo-pdf-correction-authorization-v2.json"
)
...
def main() -> int:
    ...
    required = [
        ...
        "TRINITY_RESEARCH_PREPRINT_PDF_CORRECTION_V2_APPROVED",
    ...
    for marker in [
        ...
        '"action": "replace_known_standalone_pdf_with_corrected_revision"',
        '"corrected_sha256": "b391776db76f533799dc582f39af54d2e885fe2ed1982cfe3024a1400a403e9c"',
        '"create a new version"',
        '"change the DOI"',
        '"change the Trinity Accord Canon"',
    ]:
        require(marker in authorization, f"authorization is missing: {marker}")

    print("PASS: Zenodo standalone-PDF correction workflow is bounded and fail-closed")
    return 0
