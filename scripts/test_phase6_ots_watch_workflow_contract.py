...
def main() -> None:
    ...
    workflow_markers = [
        ...
        "archive upgraded OTS proof on Arweave",
    ...
    runner_markers = [
        ...
        "upgraded bundle sha already exists in registry; refusing duplicate paid upload",
        ...
        "latest_upgraded_tx_id not updated to upgraded tx",
        "latest_verified_tx_id must remain null for upgraded bundles",
        ...
        "build_upgraded_bundle",
        "RECORD_TYPE_UPGRADED",
        "calendar_attested",
