...
def render(status: dict[str, Any]) -> str:
    ...
    heartbeat_as_of = html.escape(str(heartbeat.get("generated_at") or "unknown"), quote=True)
    public_as_of = html.escape(str(status.get("generated_at") or "unknown"), quote=True)
...
<section class="home-status-summary" aria-labelledby="home-status-title">
  ...
  <div class="home-live-signal-grid" aria-label="Live operational, reception, and evidence signals">
    <a class="home-live-signal home-live-signal-heartbeat" href="/api/waiting-heartbeat-status.json">
      ...
      <strong data-home-heartbeat-status>Last known: {heartbeat_display}</strong>
      <small data-home-heartbeat-summary>{heartbeat_note}</small>
      <small data-home-heartbeat-freshness data-status-as-of="{heartbeat_as_of}" role="status">Last known record: {heartbeat_as_of}. Current state unconfirmed.</small>
    </a>
  ...
  <p data-home-public-freshness data-status-as-of="{public_as_of}" role="status">Last known counters: {public_as_of}. Current state unconfirmed.</p>
