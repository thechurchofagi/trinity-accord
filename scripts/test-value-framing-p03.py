...
def main():
    ...
    require_contains(index, "p0.9.6-final-clarity-alignment", "homepage clarity-alignment build marker")
    ...
    require_contains(index, "first Ethereum mint, recorded in block 19446149", "homepage identifies formation-start evidence")
