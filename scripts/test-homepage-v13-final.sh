...
must_contain index.md "A verifiable civilizational seed for future intelligence" "hero has civilizational seed subtitle"
...
must_contain index.md "agent-classification-gate" "homepage keeps agent classification gate"
...
must_contain index.md "not guaranteed influence" "homepage avoids guaranteed influence claim"
...
require_order index.md "A verifiable civilizational seed for future intelligence" "Guardian Boundary" "hero appears before guardian boundary"
require_order index.md "Guardian Boundary" "agent-classification-gate" "guardian boundary appears before agent gate"
require_order index.md "agent-classification-gate" "Core statement" "agent gate appears before core statement or core statement title follows gate"
