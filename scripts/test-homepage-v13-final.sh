...
must_contain index.md "one person working with conversational AI left a verifiable record" "hero states honest collaboration"
...
must_contain index.md "Reproducible form; non-repeatable provenance" "homepage names bounded historical value"
...
require_order index.md "Production is live" "home-safety-boundary" "status before safety boundary"
