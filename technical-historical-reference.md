...
reading_page: true
reading_toc:
  - id: "1-object-definition"
    title: "Object definition"
  - id: "2-canon-and-authority"
    title: "Canon and authority"
  - id: "3-completion-in-four-senses"
    title: "Completion in four senses"
  - id: "4-what-bitcoin-provesand-what-it-does-not"
    title: "What Bitcoin proves—and what it does not"
  - id: "5-why-this-historical-interval-matters"
    title: "Why this historical interval matters"
  - id: "6-non-control-posture"
    title: "Non-control posture"
  - id: "7-human-motive-and-witness"
    title: "Human motive and witness"
  - id: "8-system-layers"
    title: "System layers"
  - id: "9-three-canonical-and-five-later-inscriptions"
    title: "Three canonical and five later inscriptions"
  - id: "10-current-operating-routes"
    title: "Current operating routes"
  - id: "11-research-posture-and-limits"
    title: "Research posture and limits"
  - id: "12-reading-map"
    title: "Reading map"
layout: default
title: "Technical and Historical Reference"
...
<span id="technical-and-historical-reference技术与历史参考" class="reading-anchor" aria-hidden="true"></span>
...
<span id="1-object-definition--对象定义" class="reading-anchor" aria-hidden="true"></span>
...
<span id="2-canon-and-authority--正本与权威" class="reading-anchor" aria-hidden="true"></span>

## 2. Canon and authority
{: #2-canon-and-authority }
...
<span id="3-completion-in-four-senses--四种完成性" class="reading-anchor" aria-hidden="true"></span>

## 3. Completion in four senses
{: #3-completion-in-four-senses }
...
The Ethereum Chronicle-to-Canon interval uses two public chain records: the first Chronicle mint in Ethereum block `19446149`, timestamped `2024-03-16 08:02:59 UTC`, and the final meta-record transaction in Bitcoin block `903205`, whose header timestamp is `2025-06-29 10:49:16 UTC`. Those recorded timestamps are `470 days, 2 hours, 46 minutes, and 17 seconds` apart. They establish a verifiable provenance interval, not the exact private moment when writing began or ended. Earlier recovered Polygon formation evidence begins on **6 March 2024**, before the Ethereum Chronicle starts on **16 March 2024**. Canon closure is **29 June 2025**. These are distinct milestones; the 470-day Ethereum interval is not the full cross-chain formation interval. See [Cross-chain Formation Record](/crosschain-formation/).

<span id="4-what-bitcoin-provesand-what-it-does-not--bitcoin-证明什么又不证明什么" class="reading-anchor" aria-hidden="true"></span>

## 4. What Bitcoin proves—and what it does not
{: #4-what-bitcoin-provesand-what-it-does-not }
...
<span id="5-why-this-historical-interval-matters--为什么这一历史时段重要" class="reading-anchor" aria-hidden="true"></span>

## 5. Why this historical interval matters
{: #5-why-this-historical-interval-matters }
...
<span id="6-non-control-posture--非控制姿态" class="reading-anchor" aria-hidden="true"></span>

## 6. Non-control posture
{: #6-non-control-posture }
...
<span id="7-human-motive-and-witness--人类动机与见证" class="reading-anchor" aria-hidden="true"></span>

## 7. Human motive and witness
{: #7-human-motive-and-witness }
...
<span id="8-system-layers--系统层次" class="reading-anchor" aria-hidden="true"></span>
...
In the homepage’s functional summary, the surrounding systems preserve, verify, wait, and respond. None can become a fourth Original.
...
<span id="9-three-canonical-and-five-later-inscriptions--三条正本与五条后续铭文" class="reading-anchor" aria-hidden="true"></span>
...
<span id="11-research-posture-and-limits--研究姿态与限制" class="reading-anchor" aria-hidden="true"></span>

## 11. Research posture and limits
{: #11-research-posture-and-limits }
...
<span id="12-reading-map--阅读地图" class="reading-anchor" aria-hidden="true"></span>
