#!/usr/bin/env python3
"""Publish only the separately reserved, exact-reviewed TA12 package."""
    ...
    for delay in (0, 3, 8):
        ...
        try:
            request = urllib.request.Request('https://doi.org/' + doi,
                                             headers={'User-Agent': 'TrinityAccord-TA12-DOICheck/1.0'})
...
def run():
    ...
    output = Path('/tmp/ta12-public-readback')
