...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small General Cross-Substrate Phenomenology}
\fancyhead[R]{\small TA-TR-2026-16}
\fancyfoot[C]{\thepage}
...
with tempfile.TemporaryDirectory() as d:
 ...
 args=['pandoc',str(d/'paper.md'),'-f','markdown+tex_math_single_backslash+autolink_bare_uris-yaml_metadata_block-simple_tables-multiline_tables','-s','--top-level-division=section','-V','documentclass=article','-V','fontsize=11pt','-V','geometry:a4paper,margin=24mm','-V','mainfont=Latin Modern Roman','-V','monofont=DejaVu Sans Mono','-V','colorlinks=true','-V','linkcolor=blue','-V','urlcolor=blue','-V','linestretch=1.05','-M','title=General Cross-Substrate Phenomenology','-M','subtitle=A Type-Safe, Transformation-First Framework for Phenomenal Existence, Structure, Perspective, and Continuation','-M','author=Hongju Liu','-M','date=24 September 2026','-H',str(d/'header.tex'),'-o',str(d/'paper.tex')]
 ...
 (ROOT/'paper.tex').write_text((d/'paper.tex').read_text())
