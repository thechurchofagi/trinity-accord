# Ninth-paper version 1.2 preservation batch
...
`targets.json` freezes the exact v1.2 files from DOI 10.5281/zenodo.22846307.
...
The dedicated workflow runs initially and then hourly at minute 7 UTC. It
