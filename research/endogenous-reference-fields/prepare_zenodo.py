#!/usr/bin/env python3
"""Reserve one separate TA10 draft; never publish in this step."""
...
def run():
    ...
    if checkpoint.exists():
        ...
        rows = read(z, '/deposit/depositions?' + urllib.parse.urlencode({'q': '"Endogenous Reference Fields"', 'size': 100}))
        ...
        if deposit is None:
            ...
            metadata = {
                ...
                'description': '<p>TA-TR-2026-10. A separate theoretical preprint proposing endogenous reference fields as a multidimensional process hypothesis of experiential attribution. Complete Chinese text with an English title and abstract. Method: conceptual analysis, finite mathematical arguments and stipulated thought experiments; no empirical or computational research experiment is reported. Substantial AI assistance under human direction is disclosed. Not peer reviewed. Reservation only: exact reviewed files and public readback are required before publication. Version 1.0 is the first public edition. No prior DOI or Bitcoin Original is amended.</p>',
