...
def run():
    ...
    if checkpoint.exists():
        ...
        rows=read(z,'/deposit/depositions?'+urllib.parse.urlencode({'q':'"Cross-Substrate Phenomenal Comparison"','size':100}))
        ...
        if dep is None:
            ...
            md={'upload_type':'publication','publication_type':'preprint','title':TITLE,
                ...
                'description':'<p>TA-TR-2026-15, version 1.0. English-only theoretical and methodological preprint on cross-substrate phenomenal comparison. Typed claims, local interfaces, guarded transport, explicit uncertainty, and a reproducible finite-state illustration. Substantial AI assistance under human direction. Not peer reviewed; no empirical consciousness detection is claimed.</p>',
