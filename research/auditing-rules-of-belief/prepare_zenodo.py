#!/usr/bin/env python3
"""Reserve one separate TA11 draft; never publish in this step."""
...
def run():
    ...
    if checkpoint.exists():
        ...
        rows = read(z, '/deposit/depositions?' + urllib.parse.urlencode({'q': '"Auditing the Rules of Belief"', 'size': 100}))
        ...
        if deposit is None:
            ...
            metadata = {
                ...
                'description': '<p>TA-TR-2026-11. A separate theory-method preprint on formative epistemic audit, epistemic-policy interventions, self-referential provenance audit, and prospective model self-forecasting. Complete Chinese text with an English title and abstract. It includes two deterministic model-organism demonstrations and a dated GPT-5.6 Sol forecast that is explicitly not treated as experimental evidence. Substantial AI assistance under human direction is disclosed. Not peer reviewed. Reservation only: exact reviewed files and public readback are required before publication. Version 2.0 is the first public edition. No prior DOI or Bitcoin Original is amended.</p>',
