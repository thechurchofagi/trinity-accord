...
\[
\boxed{\text{successor-set belief}}
\]

and:

\[
\boxed{\text{set-valued causal inheritance}.}
\]
...
\[
\boxed{pb_id.functional_acc_mean:.3f}
\]
...
\[
\boxed{pb_shift.functional_acc_mean:.5f}
\]
...
\[
\boxed{pb_hold.functional_acc_mean:.3f}.
\]
...
\[
\boxed{\text{state identification}}
\]

and:

\[
\boxed{\text{complete intervention-dynamics identification}}.
\]
