...
Stable `txid+iN` Ordinals inscription IDs are the primary identities. Numeric inscription numbers are not used as authority keys.
...
For inherited v1 witnesses, the frozen v1 verifier continues to prove body/Taproot/signature binding; v2 reopens those same reveal bytes to prove tag-5 metadata presence/absence and binds their body hashes to the address-wide archive.
