...
| Mirror | URL | Role |
|--------|-----|------|
| Website | https://www.trinityaccord.org | Primary access and verification mirror |
| GitHub | https://github.com/thechurchofagi/trinity-accord | Source repository and fallback archive |
| Ethereum | [0xbc63566...54A8](https://etherscan.io/address/0xbc63566A41cBfDB9C266a5941CBe47894DaA54A8) | Cross-chain context and timestamp mirror |
| Arweave | See [/api/evidence-manifest.json](/api/evidence-manifest.json) | Durable evidence and archive mirror |
| IPFS | See [/api/evidence-manifest.json](/api/evidence-manifest.json) | Content-addressed archive mirror |
| Record-Chain | [/record-chain/](/record-chain/) | Append-only later-record and evidence trail; non-amending |

> If Arweave or IPFS gateways are unavailable, use the GitHub mirror as fallback. The GitHub `arweave-backup/files/` directory contains SHA-256 verified copies of Arweave-stored assets.

Machine-readable manifest: [/api/authority.json](/api/authority.json)  
Authority-address inscription stack: [/authority-address-inscriptions/](/authority-address-inscriptions/) · [/api/bitcoin-inscription-mirror-index.json](/api/bitcoin-inscription-mirror-index.json)
