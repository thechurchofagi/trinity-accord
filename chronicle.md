...
- [Read the rendered Markdown on GitHub](https://github.com/thechurchofagi/trinity-accord/blob/main/nft-text-descriptions/chronicle-abridged.md)
- <a href="/nft-text-descriptions/chronicle-abridged.md" download>Download the Markdown file</a>
- [Open the same-site raw file](/nft-text-descriptions/chronicle-abridged.md)

**Ultra-brief 175-entry timeline — fastest navigation**

- [Read the rendered Markdown on GitHub](https://github.com/thechurchofagi/trinity-accord/blob/main/nft-text-descriptions/chronicle-ultra-brief.md)
- <a href="/nft-text-descriptions/chronicle-ultra-brief.md" download>Download the Markdown file</a>
- [Open the same-site raw file](/nft-text-descriptions/chronicle-ultra-brief.md)

**Full edition — exact corpus, large and repetitive by design**

- [Read the rendered Markdown on GitHub](https://github.com/thechurchofagi/trinity-accord/blob/main/nft-text-descriptions/chronicle-full.md)
- <a href="/nft-text-descriptions/chronicle-full.md" download>Download the Markdown file</a>
...
| Corrected agent context | [Markdown](/nft-text-descriptions/chronicle-agent-context.md) |
| Machine index | [JSON](/nft-text-descriptions/chronicle-index.json) |
| Machine summary | [JSON](/nft-text-descriptions/chronicle-summary.json) |
| Music audit | 175 NFTs audited; 144 lyrics records; 10 title-only references; 21 no-song entries |
...
- its boundaries were calendar buckets given narrative names by an AI-generated script;
- the NFTs themselves did not author or ratify those stages;
...
- **overlapping descriptive categories** — search aids, not stages or factual verification;
- **interpretive analysis** — provisional, revisable, and clearly distinguished from source text.
...
- songs, poems, letters, warnings, elegies, and symbolic responses;
- artwork and music-related context;
- family and personal witness;
...
- independent verification of all external events;
- proof that a real-world event occurred at the NFT mint time;
- audio verification or copyright verification;
- investment evidence;
- religious authority;
- a command to future intelligence;
...
3. [`/nft-text-descriptions/chronicle-ultra-brief.md`](/nft-text-descriptions/chronicle-ultra-brief.md)
4. [`/nft-text-descriptions/chronicle-abridged.md`](/nft-text-descriptions/chronicle-abridged.md)
5. [`/nft-text-descriptions/chronicle-index.json`](/nft-text-descriptions/chronicle-index.json)
...
3. [`/nft-text-descriptions/chronicle-index.json`](/nft-text-descriptions/chronicle-index.json)
