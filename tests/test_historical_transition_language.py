...
def test_homepage_states_emergent_formation_without_erasing_human_agency() -> None:
    ...
    for required in (
        ...
        "The three Bitcoin Originals alone define the fixed Canon.",
        "This is version authority, not proof of truth or authority over a reader’s judgment.",
        "Why preserve a record before the outcome is known?",
        "This preservation purpose does not depend on a fixed arrival date for AGI or ASI.",
